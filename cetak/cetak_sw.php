...
while ($sw = mysqli_fetch_array($sql)) {
    ...
    $html .= ' <tr class="table-w">
                    ...
                    <td align="center">' . $sw["ID_Simpanan"] . '</td>
                    <td align="center">' . $sw["ID_Tabungan"] . '</td>
                    <td width="250px">' . $sw["Nama_Anggota"] . '</td>
                    <td align="center">' . tgl($sw["Tanggal_Transaksi"]) . '</td>
                    <td align="right">' . rp($sw["Saldo_Simpanan"]) . '</td>
                </tr>';
}
$no++;
$html .= ' </tbody>
