...
$sds         = $total_sw['Total_Dana_Sosial'];
...
<head>
    ...
    <title>Laporan Simpanan Dana Sosial</title>
</head>
<body>
    <h1>KOPERASI RUKUN SANTOSO</h1>
    <h3>Simpanan Dana Sosial</h3>
    <span>Total: ' . rp($sds) . '</span>
    <hr>
...
while ($ds = mysqli_fetch_array($sql)) {
    ...
    $html .= ' <tr class="table-w">
                    ...
                    <td width="270px">' . $ds["Nama_Anggota"] . '</td>
                    <td align="center">' . tgl($ds["Tanggal_Transaksi"]) . '</td>
                    <td align="right">' . rp($ds["Saldo_Simpanan"]) . '</td>
                </tr>';
}
$no++;
$html .= ' </tbody>
