                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr style="<?= $color; ?>">
                                                ...
                                                <td align="right"><?= rp($ssAnggota); ?></td>
                                                <td align="center"><?= $s["Status_Simpanan"]; ?></td>
                                                <td align="center"><a href="detail_simpanan_sukarela.php?ID_Anggota=<?= $s['ID_Anggota'] ?>" title="Detail Simpanan Sukarela <?= $s['Nama_Anggota']; ?>"><button class="btn btn-icon btn-outline-primary"><i class='fas fa-eye'></i></button></a></td>
                            ...
                            <div class='border'>
                                <p class="p-2">Total Simpanan Sukarela : <?php if (isset($ss)) {
                                                                                echo rp($ss);
                                                                            } ?></p>
                            </div>
                        </div>
