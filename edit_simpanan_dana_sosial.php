...
<div class="main-content">
    <div class="container-fluid">
        <ol class="breadcrumb mb-4" style="font-size: 16px">
            ...
            <li class="breadcrumb-item"><a href="simpanan_dana_sosial.php">Simpanan Wajib</a></li>
            <li class="breadcrumb-item no-drop active">Edit Simpanan Wajib</li>
            <li class="ml-auto active font-weight-bold">Edit Simpanan Wajib</li>
        </ol>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6 container">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="md-form mt-0">
                                                <input class="form-control" type="text" value="<?= $sw['ID_Simpanan'] ?>" name="ID_Simpanan" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="md-form mt-0">
                                                <input class="form-control" type="text" value="<?= $sw['ID_Anggota']; ?>" name="ID_Anggota" readonly>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="md-form mt-0">
                                                <select name="Jenis_Simpanan" class="form-control" id="exampleSelectGender">
                                                    ...
                                                    <option value="Simpanan Wajib" <?= $sw['Jenis_Simpanan'] == 'Simpanan Wajib' ? 'selected' : "" ?>>Simpanan Wajib</option>
                                                    <option value="Simpanan Sukarela" <?= $sw['Jenis_Simpanan'] == 'Simpanan Sukarela' ? 'selected' : "" ?>>Simpanan Sukarela</option>
                                                    <option value="Simpanan Dana Sosial" <?= $sw['Jenis_Simpanan'] == 'Simpanan Dana Sosial' ? 'selected' : "" ?>>Simpanan Dana Sosial</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="md-form mt-0">
                                                <input type="text" class="form-control" value="<?= $sw['Tanggal_Transaksi'] ?>" id="Tanggal_Transaksi" name="Tanggal_Transaksi" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="md-form mt-0">
                                                <input type="text" class="form-control" id="Saldo_Simpanan" value="<?= $sw['Saldo_Simpanan']; ?>" name="Saldo_Simpanan" required>
                                                <div class="valid-feedback">Valid.</div>
                                                <div class="invalid-feedback">Harap isi kolom ini.</div>
                                            </div>
                                        </div>
